...
const News = () => {
  ...
  return (
    <div id="news" style={{  
      ...
      <button style={{ height: '40px', width: '200px', backgroundColor: '#FFFFFF', color: '#003366', padding: '10px   20px', borderRadius: '5px', border: 'none', cursor: 'pointer', transition: 'background-color   0.3s ease' }}>View More</button>
    </div>
  );
};
